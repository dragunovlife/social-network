...
const T2 = (props) => {
	return (
		<div>
			...
			<p className={classes.p}>React Props</p>
			<p className={classes.p}>React State</p>
...
const T5 = (props) => {
	return (
		<div>
			<img src ='http://old.code.mu/images/mr-koder/sleep.png' />
			<div className={classes.progressbar1}>

			</div>

			<h6>http://old.code.mu/books/advanced/javascript/react/</h6>
			<h6>Учебник по фреймворку React</h6>
			<p className={classes.p}>Учебник по React для новичков по-русски</p>
		</div>	
		)
}
